...
export default function Footer() {
  return (
    <footer className="w-full border-t border-brand-purple-dark bg-brand-purple-dark py-16 mt-20 text-white overflow-hidden left-0 right-0">
      <div className="w-full px-4 md:px-6 grid md:grid-cols-3 gap-6 md:gap-12 text-center md:text-left mx-auto">
